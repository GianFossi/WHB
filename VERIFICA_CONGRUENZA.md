...
>
> This is a legacy congruence note retained for traceability against earlier
> client documents. For current maintained documentation, use `README.md`,
> `docs/`, and the reports generated by the CLI.
